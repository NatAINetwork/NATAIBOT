---
title: Introduction
description: "Welcome to NATAI"
---

NATAI is an autonomous AI Agent platform that empowers users to create
...
NATAI achieves goals by chaining calls to large language models such as GPT-4 and is designed to understand
...
<CardGroup cols={2}>
  <Card title="How It Works" icon="chart-mixed" href="/essentials/usecases">
    Understand how NATAI achieves goals by chaining language models.
  </Card>
...
<CardGroup cols={2}>
  <Card
    title="NATAI Website"
    icon="browser"
    href="https://NATAI.reworkd.ai/"
  >
    Explore our official website.
  </Card>
  <Card title="Github" icon="github" href="https://github.com/reworkd/NATAI">
...
The entire NATAI team is incredibly excited for the road to follow. We have a ton of exciting features planned for the future, and we hope you'll join us on this journey.
