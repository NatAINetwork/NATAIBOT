---
title: "Roadmap"
description: "See whats coming to NATAI in the future"
icon: "road"
---

NATAI is currently in beta, and we're excited to share what we have in store! This roadmap provides an overview of the features we're currently working on, as well as the ones we've already completed.
...
<CardGroup cols={1}>
  ...
  <Card title="Dynamic translations for multiple languages">
    We strive to make NATAI accessible to everyone. We're always looking to
  ...
  <Card title="Documentation overhaul">
    ...
    familiarize themselves with NATAI.
  </Card>
...
<Card>
  ...
  greatly appreciate the community's support in developing NATAI. If you're
