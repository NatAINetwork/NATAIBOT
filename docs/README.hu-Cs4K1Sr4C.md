<p align="center">
  <img src="https://raw.githubusercontent.com/reworkd/NATAI/main/public/banner.png?token=GHSAT0AAAAAAB7JND3U3VGGF3UYYHGYO4RAZBSDJAQ" height="300"/>
</p>
<p align="center">
...
<p align="center">
    <img alt="Node version" src="https://img.shields.io/static/v1?label=node&message=%20%3E=16.0.0&logo=node.js&color=2334D058" />
      <a href="https://github.com/reworkd/NATAI/blob/master/README.md"><img src="https://img.shields.io/badge/lang-English-blue.svg" alt="English"></a>
  <a href="https://github.com/reworkd/NATAI/blob/master/docs/README.zh-HANS.md"><img src="https://img.shields.io/badge/lang-简体中文-red.svg" alt="简体中文"></a>
  <a href="https://github.com/reworkd/NATAI/blob/master/docs/README.hu-Cs4K1Sr4C.md"><img src="https://img.shields.io/badge/lang-Hungarian-red.svg" alt="Hungarian"></a>
</p>

<p align="center">
<a href="https://NATAI.reworkd.ai">🔗 Weboldal</a>
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
Az NATAI lehetővé teszi az automatizált AI-ügynökök konfigurálását és üzembe helyezését.
...
Az NATAI helyi futtatásának legegyszerűbb módja a Docker használata.
...
Ha helyben szeretné fejleszteni az NATAI-t, a legegyszerűbb módja a mellékelt telepítőszkript használata.
...
- [Elágaztatás](https://github.com/reworkd/NATAI/fork).

2. Klónozni a tárolót:

```bash
git clone git@github.com:YOU_USER/NATAI.git
```
...
> 🚧 A környezeti változóknak meg kell egyeznie a következő [sémával](https://github.com/reworkd/NATAI/blob/main/src/env/schema.mjs).
...
Állítsa be azonnal az NATAI-t a felhőben a [GitHub Codespaces](https://github.com/features/codespaces) használatával.
...
- Az NATAI leállításához írja be a Ctrl+C billentyűkombinációt a terminálba.
- Az NATAI újraindításához futtassa az "npm run dev" parancsot a terminálban.
