<p align="center">
  <img src="https://raw.githubusercontent.com/reworkd/NATAI/main/next/public/banner.png" height="300" alt="NATAI Logo"/>
</p>
<p align="center">
...
<p align="center">
<a href="https://NATAI.reworkd.ai">🔗 短链接</a>
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
## ✨ 演示
为了获得最佳的演示体验，请直接访问 [our site](https://NATAI.reworkd.ai) :)

[Demo Video](https://github.com/reworkd/NATAI/assets/50181239/5348e44a-29a5-4280-a06b-fe1429a8d99e)


## 👨‍🚀 开始使用

使用NATAI的最简单方法是自动设置CLI，该CLI与项目捆绑在一起。
cli为NATAI设置了以下内容：
- 🔐 [Environment variables](https://github.com/reworkd/NATAI/blob/main/.env.example) (和 API 密钥)
- 🗂️ [Database](https://github.com/reworkd/NATAI/tree/main/db) (Mysql)
- 🤖 [Backend](https://github.com/reworkd/NATAI/tree/main/platform) (FastAPI)
- 🎨 [Frontend](https://github.com/reworkd/NATAI/tree/main/next) (Nextjs)
...
3. **克隆存储库并进入目录** - 一旦您的终端打开，您可以通过运行下面的命令克隆存储库并进入目录。
   ...
   **For Mac/Linux users** 🍎 🐧
   ```bash
   git clone https://github.com/reworkd/NATAI.git
   cd NATAI
   ./setup.sh
   ```
...
<p align="center">
加入我们，共同推动NATAI的发展，这是一个突破人工智能代理边界的开源项目！您的赞助将通过帮助我们扩大资源、增强功能和继续迭代这个令人兴奋的项目来推动进步！🚀
</p>
...
<a href="https://github.com/reworkd/NATAI/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=reworkd/NATAI" />
</a>
