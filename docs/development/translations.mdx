...
NATAI has translations across a variety of languages thanks to the help of many contributors such as @Cs4K1Sr4C.
...
in [next/public/locales](https://github.com/reworkd/NATAI/tree/main/next/public/locales).
...
in [next/public/locales](https://github.com/reworkd/NATAI/tree/main/next/public/locales) and add translations for all
...
We have a few README translations that live in [main/docs](https://github.com/reworkd/NATAI/tree/main/docs) such
...
<a href="https://github.com/reworkd/NATAI/blob/master/README.md">
