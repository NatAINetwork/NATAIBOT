---
title: Memory
description: Understanding how NATAI manages memory with the help of vector databases.
icon: "brain"
---

# Memory Management in NATAI
...
1. Weaviate is open-source and conveniently accessible via docker-compose, eliminating the need for an API key for local NATAI runs.
