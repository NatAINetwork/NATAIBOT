          ...
          <Terminal className="absolute" title="index.ts">
            <pre className="overflow-x-hidden">
              {"" +
                ...
                "<html>\n" +
                "<head>\n" +
                " <title>My NATAI Website</title>\n" +
                "</head>\n" +
                "<body>\n" +
                "  <h1>Welcome to NATAI!</h1>\n" +
                "  <p>Explore the power of autonomous AI agents.</p>\n" +
                '  <script src="https://NATAI.reworkd.ai/NATAI.js"></script>\n' +
                "  <script>\n" +
                "    // Connect to NATAI API\n" +
                "    const agent = new NATAI();\n" +
                "    agent.connect('YOUR_API_KEY');\n" +
                "    \n" +
                "    // Example code to interact with NATAI\n" +
          ...
          <Terminal className="absolute left-16 top-20 z-10" title="agent_service.py">
            <pre className="overflow-x-hidden">
              {"import requests\n" +
                ...
                'url = "https://api.NATAI.example.com"\n' +
                "\n" +
