...
const navigation = [
  ...
  { name: "Pricing", href: "https://NATAI.reworkd.ai/plan", icon: <PricingIcon /> },
  {
    name: "Github",
    href: "https://github.com/reworkd/NATAI",
    icon: <GithubIcon />,
  },
          ...
          <>
            <div className="align-center flex h-16 flex-row justify-between">
              ...
              <div className="hidden justify-end gap-2 xmd:flex sm:items-center lg:flex-1">
                <TextButton
                  onClick={() => {
                    router.push("https://NATAI.reworkd.ai/").catch(console.error);
                  }}
                >
                  <>
                    <span>Try demo</span>
